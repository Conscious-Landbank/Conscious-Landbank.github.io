 ...
 * (PRD §6.1 / §6.3). Surfaces where a mint/burn is: payment settled → compliance
 * cleared → hold → minted, or burn → liquidity → disbursed. Honest progress, not
 * just a "done" celebration.
 */
