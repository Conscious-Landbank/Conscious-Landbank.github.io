...
- When to show: only when the recipient address was typed/pasted (not already saved). **When NOT to use:** Buy, Swap and Trade. No recipient address exists in those flows, so there is nothing to save.
