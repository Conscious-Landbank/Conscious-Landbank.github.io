# Test Cases — Huma Humanity Centers & Donation
...
## 13.5 — Crypto path, settlement and Uniswap routing (DON-CRYPTO-01…06)
...
| TC-DET-22 | Edge | P2 | Any HC, metrics unavailable pill | Toggle the pill | Both metric cards read **"Metrics unavailable"**; profile, programs and gallery still render | HC-DETAIL-03, §6.2 |
