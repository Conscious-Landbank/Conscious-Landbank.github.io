...
(function () {
  ...
  var DEFAULT = [
    ...
    { id: 'up_don_pending', level: 'progressing', category: 'transaction',  title: 'Donation pending', message: 'Your donation of $250.00 to Kibera Community Center is on its way. Usually takes 2\u20135 minutes \u2014 nothing to do.', ref: 'Ref DON-401288', timestamp: new Date(Date.now() - 2 * 60 * 1000).toISOString(), read: false, ctaUrl: 'donate.html', ctaLabel: 'View status' },
    ...
    { id: 'up_don_submitted', level: 'info',        category: 'donation', title: 'Donation submitted', message: 'Your donation of 250 USDC (≈ $250.03) to Kibera Community Center was submitted. Total charged $252.53 including the processing fee.', ref: 'Ref DON-90412', timestamp: new Date(Date.now() - 9 * 60 * 1000).toISOString(), read: false, ctaUrl: 'donation-history.html', ctaLabel: 'View donation' },
    { id: 'up_don_awaiting',  level: 'progressing', category: 'donation', title: 'Donation awaiting confirmation', message: 'Your donation is being processed. We’ll update the status when conversion is complete.', ref: 'Ref DON-90188', timestamp: new Date(Date.now() - 14 * 60 * 1000).toISOString(), read: false, ctaUrl: 'donation-history.html', ctaLabel: 'Track donation' },
    { id: 'up_don_completed', level: 'completed',   category: 'donation', title: 'Donation completed', message: 'Your donation of $250.03 to Kibera Community Center is confirmed. Thank you.', ref: 'Ref DON-90412', timestamp: new Date(Date.now() - 35 * 60 * 1000).toISOString(), read: false, ctaUrl: 'donation-history.html', ctaLabel: 'View donation' },
    { id: 'up_don_receipt',   level: 'info',        category: 'donation', title: 'Tax receipt available', message: 'Receipt UN-2026-004182 is ready to download. It is tied to this donation’s transaction ID.', ref: 'Ref DON-90412', timestamp: new Date(Date.now() - 33 * 60 * 1000).toISOString(), read: false, ctaUrl: 'donation-history.html', ctaLabel: 'Download receipt' },
    { id: 'up_don_points',    level: 'completed',   category: 'donation', title: 'Huma Points updated', message: 'Your Huma Points for donation DON-90412 moved to confirmed: 12.5 Huma Points.', ref: 'Ref DON-90412', timestamp: new Date(Date.now() - 31 * 60 * 1000).toISOString(), read: false, ctaUrl: 'donations.html', ctaLabel: 'View impact' },
    { id: 'up_don_failed',    level: 'error',       category: 'donation', title: 'Donation failed', message: 'We could not process the payment right now. Please try again.', ref: 'Ref DON-89544', timestamp: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(), read: true, ctaUrl: 'donate.html', ctaLabel: 'Try again' }
  ];
  ...
  if (!Array.isArray(notifications) || notifications.length === 0) {
    ...
    var have = {};
    notifications.forEach(function (n) { have[n.id] = true; });
    DEFAULT.forEach(function (n) { if (!have[n.id]) notifications.push(JSON.parse(JSON.stringify(n))); });
