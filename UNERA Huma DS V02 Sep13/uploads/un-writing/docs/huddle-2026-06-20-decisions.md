...
- No third-party provider quotes (no MoonPay/Banxa aggregator). Huma is the OTC seller; BE adds a **quote/price-lock server** so the rate is held briefly -> keep the single-provider OTC preview + quote countdown. [VTT 292]
