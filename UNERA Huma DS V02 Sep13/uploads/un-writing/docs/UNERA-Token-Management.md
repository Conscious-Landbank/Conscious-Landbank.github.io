# Huma token management

> Source: [Huma - Token Management](https://conscious-landbank.atlassian.net/wiki/spaces/~7120206e88bad7379045fb808e0bd72c8daf86/pages/62259420/UNERA+-+Token+Management) (Confluence) · v17, last updated 2026-06-11

# 1. Introduction

## 1.1 Purpose

This document defines the user-facing token transaction actions in the Huma Platform: wallet connection; Buy hUSD via OTC; Trade; Swap; Send Token.
...
- Huma Platform user-facing copy should avoid Stablecoin Layer terms such as mint, burn, issuance, and redemption. Use Purchase / Sell where applicable.
...
| Platform Fee | Configurable fee paid to Huma. Set to **0 at launch**, adjustable later. |
...
| Platform Fee | Configurable fee paid to Huma, set to 0% at launch. |
...
- Transaction preview shows input token, output token, exchange rate, price safety/slippage setting, deadline, plus estimated gas.
...
- Errors should be short and actionable, and they should name the step that failed.
...
- [Huma - Token Swap](https://conscious-landbank.atlassian.net/wiki/spaces/~7120206e88bad7379045fb808e0bd72c8daf86/pages/56525008)
