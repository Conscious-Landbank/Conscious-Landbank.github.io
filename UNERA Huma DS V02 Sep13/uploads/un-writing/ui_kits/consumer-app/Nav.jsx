  ...
  return (
    <nav className="nav" aria-label="Main navigation">
      <div className="nav-left">
        <button className="nav-brand" onClick={() => onNav("dashboard")} aria-label="Huma home">
          <img className="nav-logo-img" src="../../assets/logos/huma-white-text-nav.svg" alt="Huma" />
        </button>
