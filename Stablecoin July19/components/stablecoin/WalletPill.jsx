...
/**
 * WalletPill — the progressive Web3 identity control in the nav.
 * Disconnected → a "Connect wallet" button. Connected → a pill with a blockie
...
export function WalletPill({ connected = false, address = '', balance = '', network = 'Ethereum', initials = 'JS', onConnect, onClick, onNetwork, style }) {
  ...
  // Connected → single boxed white pill: avatar · wallet (address + balance) · network badge
  return (
    <div style={{
