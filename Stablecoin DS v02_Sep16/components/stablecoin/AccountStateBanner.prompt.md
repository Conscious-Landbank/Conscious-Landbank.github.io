...
Source: *Dashboard* (66912287) §7 user states, §11 operational notices.
...
## Rules
- Never expose a compliance reason, sanctions detail, or risk score. Safe guidance and a next step only.
