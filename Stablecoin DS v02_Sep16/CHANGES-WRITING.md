...
## Round 2 (2026-09-09): the 0908 public-layer copy

The mission, use-cases, auth-panel and Get-screen copy added after the first sweep was audited
against the same skill. Fixed: 14 spaced em dashes became colons, commas, semicolons or full
stops; one rhetorical question answered at once ("Want to give directly? Donations live on…"
is now "Direct donations live on the Huma Platform"); "And simply by existing" lost its
"simply"; "quietly funds" lost its "quietly"; the em-dash pair around "the Passive Reserve
Yield" became commas; "The Swiss Association — not the issuer — decides" now leads with the
fact; a three-beat fragment headline became two sentences ("One dollar in, one hUSD out.
Every step accounted for."); and the "steady / moving / welcome" autopilot triple was cut to
two. The `USD → hUSD` flow arrows in diagrams stay, as §7 allows. The Get-screen flow caption
was then removed entirely at Minh's request.
