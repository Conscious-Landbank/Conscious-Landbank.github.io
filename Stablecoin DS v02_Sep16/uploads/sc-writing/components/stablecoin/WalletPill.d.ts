...
export interface WalletPillProps {
  /** false gives the "Connect wallet" CTA; true gives the connected identity pill. */
  connected?: boolean;
  address?: string;
  balance?: string;
  network?: string;
 ...
 * @startingPoint section="Stablecoin" subtitle="Connect, then connected wallet pill" viewport="700x120"
 */
