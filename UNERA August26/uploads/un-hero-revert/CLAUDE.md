...
- **The compact balance hero is for the Unera Stablecoin portal only.** The consumer Wallet and Dashboard never lead with a balance figure: balances stay inside the Balances section, behind the show/hide toggle, hidden by default (`balancesHidden = true`, the button reads "Show Balances"). Decision: Renol, 23 Aug 2026.
