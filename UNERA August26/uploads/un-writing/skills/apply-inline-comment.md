...
4. If it is ambiguous which element or what behavior, ask, though usually the chain is enough to infer.

## Make ONLY the requested change
5. Change exactly what's asked; do not touch the surrounding layout, spacing, colours or content. Prefer `str_replace_edit` over rewriting the file.
