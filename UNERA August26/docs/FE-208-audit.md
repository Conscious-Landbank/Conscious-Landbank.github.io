# FE-208 gap audit: Humanity Centers and Donation
...
5. Only 4 of the 14 §6.3 error strings are verbatim. Several are close-but-wrong ("Unable to complete this **action**" vs "this **donation**"), and there are no strings for conversion, timeout or receipt.
