...
(function () {
  ...
  function feeUSD() {
    return D.processingFee(method, totalUSD(), rail);
  }
  function convFeeUSD() {
  ...
  function renderCentres() {
    ...
    pick.querySelectorAll('.centre-pick-row').forEach(function (row) {
      row.addEventListener('mouseenter', function () {
        showHcPreview(row, row.getAttribute('data-id'));
      });
