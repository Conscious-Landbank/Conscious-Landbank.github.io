...
(function () {
  'use strict';
  var CENTRES = [
    { id: 'hc-nairobi', name: 'Kibera Community Centre', country: 'Kenya', region: 'Africa', active: true,
      ...
      milestones: [ { year: "2018", text: "Centre founded; the first 120 children enroll." }, { year: "2020", text: "Community water kiosks reach 1,200 families." }, { year: "2023", text: "Daily meals launch; attendance climbs to 94%." }, { year: "2025", text: "540 children are now in full-time school." } ],
    ...
    { id: 'hc-manila', name: 'Tondo Youth Centre', country: 'Philippines', region: 'Asia', active: true,
      ...
      story: { name: "Mark, age 19", text: "Mark left school at 15 to scavenge alongside his family. He enrolled in the centre's carpentry track, was paired with a mentor, and earned a national skills certificate within a year. He now apprentices at a furniture workshop and mentors two younger trainees himself. Your gift keeps that pipeline open." },
      ...
      milestones: [ { year: "2016", text: "Centre opens with a single carpentry workshop and 40 trainees." }, { year: "2019", text: "Mentorship program launches; the first 100 graduates are certified." }, { year: "2022", text: "Typhoon-readiness added; the 800th young person enrolls." }, { year: "2025", text: "73% of graduates are now in stable work or further study." } ],
    ...
    { id: 'hc-lapaz', name: 'El Alto Family Centre', country: 'Bolivia', region: 'South America', active: true,
      ...
      milestones: [ { year: "2019", text: "Centre opens; the first mobile-clinic route launches." }, { year: "2021", text: "Licensed day care opens with 180 places." }, { year: "2023", text: "Nutrition program reaches every under-five on the route." }, { year: "2025", text: "3,400 clinic visits delivered in a single year." } ],
    ...
    { id: 'hc-colombo', name: 'Colombo Coastal Centre', country: 'Sri Lanka', region: 'Asia', active: true,
      ...
      milestones: [ { year: "2017", text: "Centre founded to support coastal fishing cooperatives." }, { year: "2020", text: "Boat-safety certification introduced." }, { year: "2024", text: "After the floods, 60 homes and 200 livelihoods rebuilt." }, { year: "2025", text: "Every partnered boat crew is now safety-certified." } ],
    ...
    { id: 'hc-accra', name: 'Accra Learning Hub', country: 'Ghana', region: 'Africa', active: true,
      ...
      story: { name: "Efua, age 27", text: "Efua ran a market stall with no way to track her money. She took the centre's bookkeeping and digital-skills courses at night; within a year she had formalised her business, opened a second stall and hired her first employee. Your gift funds the next Efua's seat in the lab." },
    ...
    { id: 'hc-dhaka', name: 'Dhaka Health Outreach', country: 'Bangladesh', region: 'Asia', active: false,
      ...
      story: { name: "Shirin, new mother", text: "Shirin had no antenatal care until a centre midwife began home visits on her lane. Regular checkups carried her through a safe delivery, and her newborn started life with a full immunisation record." },
      ...
      milestones: [ { year: "2015", text: "Centre founded; the first mobile-clinic route launches." }, { year: "2019", text: "Maternal home-visit program reaches 2,000 mothers." }, { year: "2023", text: "9,600+ lives reached across greater Dhaka." }, { year: "2026", text: "New donations paused during an independent review." } ],
      update: { date: "Notice", text: "This centre is not accepting new donations right now. Existing program commitments continue to be honoured." },
    ...
    { id: 'hc-jakarta', name: "Jakarta Coastal Resilience Centre", country: "Indonesia", region: "Asia", active: true,
      ...
      milestones: [{"year":"2019","text":"Centre opens; first community flood barrier built."},{"year":"2021","text":"Early-warning siren network goes live."},{"year":"2023","text":"Clean-water program reaches 600 families."},{"year":"2025","text":"Flood-damage claims on protected blocks fall 70%."}],
    ...
    { id: 'hc-kampala', name: "Kampala Girls' Education Centre", country: "Uganda", region: "Africa", active: true,
      ...
      milestones: [{"year":"2017","text":"Centre opens with 60 scholarships."},{"year":"2020","text":"Peer-mentorship network launches."},{"year":"2023","text":"School health corner opens with a full-time nurse."},{"year":"2025","text":"91% of scholars now complete secondary school."}],
    ...
    { id: 'hc-amman', name: "Amman Refuge Support Centre", country: "Jordan", region: "Middle East", active: true,
      ...
      testimonial: {"quote":"They gave my children somewhere safe and gave me back my trade. That is dignity.","who":"Omar, centre graduate and volunteer"},
      ...
      milestones: [{"year":"2018","text":"Centre opens with language and childcare services."},{"year":"2020","text":"Vocational trades and job placement added."},{"year":"2023","text":"Mental-health counselling introduced."},{"year":"2025","text":"64% of trainees now find work within six months."}],
    ...
    { id: 'hc-lima', name: "Lima Highland Health Centre", country: "Peru", region: "South America", active: true,
      ...
      milestones: [{"year":"2020","text":"Centre opens; first mobile-clinic route launches."},{"year":"2022","text":"Maternal home-visit program begins."},{"year":"2024","text":"Nutrition program reaches every under-five on the route."},{"year":"2025","text":"98% of tracked pregnancies safely delivered."}],
    ...
    { id: 'hc-hanoi', name: "Hanoi Digital Futures Centre", country: "Vietnam", region: "Asia", active: true,
      ...
      milestones: [{"year":"2021","text":"Centre opens with two computer labs."},{"year":"2023","text":"Structured coding tracks and mentoring launch."},{"year":"2024","text":"Micro-business seed-grant program begins."},{"year":"2025","text":"70% of graduates now work in tech or digital roles."}],
    ...
    { id: 'hc-capetown', name: "Cape Town Early Years Centre", country: "South Africa", region: "Africa", active: true,
      ...
      milestones: [{"year":"2016","text":"Centre opens with one early-learning classroom."},{"year":"2019","text":"Daily meals program launches."},{"year":"2022","text":"Family-support and parenting workshops added."},{"year":"2025","text":"96% of children now assessed school-ready."}],
  ...
  var BALANCES = {
    ...
    tokens: [
      { symbol: 'hUSD', name: 'Unera Stablecoin', amount: 2500.00, native: false },
      { symbol: 'USDC', name: 'USD Coin', amount: 1204.10, native: false },
      { symbol: 'USDT', name: 'Tether USD', amount: 610.25, native: false },
      { symbol: 'ETH',  name: 'Ethereum', amount: 0.4200, native: true }
    ]
  };
  var PRICES = { hUSD: 1.0000, USDC: 1.0001, USDT: 0.9998, ETH: 3120.40 };
  ...
  var HISTORY = [
    { id: 'don-90412', hcId: 'hc-nairobi', source: 'crypto', status: 'completed', amount: 250, currency: 'USDC', amountUSD: 250.03,
      rate: 1.0001, txHash: '0x9b71f04c8a2e51d6b3a8f27c90e14d5a6b82c3f1a0d97e6541bc28d3f7a1904c', createdAt: iso(3, 14),
    ...
    { id: 'don-90371', hcId: 'hc-manila', source: 'fiat', status: 'completed', amount: 500, currency: 'USD', amountUSD: 500,
      rate: 1, txHash: null, createdAt: iso(11, 10),
    ...
    { id: 'don-90224', hcId: 'hc-nairobi', source: 'crypto', status: 'awaiting_confirmation', amount: 0.05, currency: 'ETH', amountUSD: 156.02,
      rate: 3120.4, txHash: '0x4c81ab90de23f761c8a05b1e94d2c7f30a6b85d19e2f4c07b3a68d51c2e09af0', createdAt: iso(0.04),
    ...
    { id: 'don-89960', hcId: 'hc-lapaz', source: 'fiat', status: 'completed', amount: 120, currency: 'USD', amountUSD: 120,
      rate: 1, txHash: null, createdAt: iso(34, 16),
      receipt: 'available', receiptNo: 'UN-2026-002851', uyt: { amount: 6.0, status: 'confirmed' } },
    { id: 'don-89712', hcId: 'hc-colombo', source: 'crypto', status: 'completed', amount: 264, currency: 'hUSD', amountUSD: 264,
      rate: 1, txHash: '0x7a3fe8c210b94d67a1f05c3e82d96b40c7a2e15f90d84b672c3a01e59f6d2b9c', createdAt: iso(58, 9),
    ...
    { id: 'don-89544', hcId: 'hc-accra', source: 'fiat', status: 'failed', amount: 75, currency: 'USD', amountUSD: 0,
      rate: 1, txHash: null, createdAt: iso(71, 11),
      receipt: 'unavailable', receiptNo: null, uyt: null }
  ];

  var SUMMARY = { totalDonatedUSD: 1290.03, livesImpacted: 38, uytConfirmed: 64.5, uytPending: 7.8, receipts: 4 };
  ...
  function getCentre(id) { return CENTRES.find(function (c) { return c.id === id; }) || CENTRES[0]; }
  ...
  function centreIndex(id) { return CENTRES.findIndex(function (c) { return c.id === id; }); }

  window.UNERA_DON = {
    blobArt: blobArt, centreIndex: centreIndex,
    CENTRES: CENTRES, BALANCES: BALANCES, PRICES: PRICES, GAS: GAS, HISTORY: HISTORY, SUMMARY: SUMMARY,
    STATES: STATES,
