# UNERA — Payee Address Management
...
- **ADDR-03** Edit label/description only. **Address itself cannot be edited** — delete & re-add to change.
...
## 9. References
Send token by saved address → UNERA Token Management §6 Send Token.
