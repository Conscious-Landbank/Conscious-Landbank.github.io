...
5. Data/content lives in a single JS module (e.g. `donation-data.js`) so images, copy, and lists change in one place — the user repeatedly asked "reuse this for all," and a single source makes that a one-line change.
