...
- **Von Restorff / scannability:** give stat cards a coloured 3px top accent (green=money, blue=structure, yellow=UYT) instead of identical tinted boxes; display-font numerals with `-0.01em` tracking.
