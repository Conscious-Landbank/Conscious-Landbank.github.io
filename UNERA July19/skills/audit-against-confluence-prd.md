...
Use when the task is "audit / check / make sure X matches the requirements," or before improving any UNERA screen. Turns a vague "is it right?" into a field-by-field verdict.
