...
function Dashboard({ onNav }) {
  ...
  const impact = [
    ...
    { icon: UI.heart, mod: "donations", value: "$5,240", label: "Total Donations", detail: "3 centres supported", trend: "+18% this month" },
  ...
  const actions = [
    ...
    { key: "centres", cls: "action-card--sky", icon: UI.explore, title: "Explore Centres", desc: "Discover where to donate" },
...
function Wallet({ onNav }) {
  ...
  const txns = [
    { date: "Today", items: [
      ...
      { type: "donation", icon: UI.heart, title: "Donation to Nairobi Humanity Centre", time: "09:15 AM", status: "completed", rail: "chain", token: "hUSD", amt: "- $250.00", amtCls: "negative", sub: "hUSD" },
...
function Notifications({ onNav }) {
  ...
  const groups = [
    { title: "New", items: [
      ...
      { cat: "donation", icon: UI.heart, title: "Donation Receipt Ready", msg: "Your $100 donation to Nairobi Hope Centre has been processed", time: "5 hours ago", cta: "View receipt", unread: true },
    ]},
    { title: "Earlier", items: [
            ...
            {g.items.map((n, i) => (
              <div className={"notif-page-item" + (n.unread ? " unread" : "")} key={i}>
                ...
                <div className="notif-page-body">
                  ...
                  {n.cta && <a className="notif-page-cta" onClick={() => onNav(n.cat === "donation" ? "centres" : "wallet")}>{n.cta}{UI.arrowRightUp}</a>}
                </div>
...
/* ─── Centres ───────────────────────────────────────────────────── */
function Centres({ onNav }) {
  const UI = window.UI;
  const centres = [
    { img: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=800&q=80", cat: "Education · Nairobi", name: "Nairobi Hope Centre", desc: "Schooling, meals and mentorship for 600 children across Kibera.", raised: 82, goal: "$120k" },
    ...
    { img: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80", cat: "Health · São Paulo", name: "São Paulo Health Centre", desc: "Primary care and maternal health for the Capão Redondo community.", raised: 47, goal: "$150k" },
  ];
  return (
    <div className="app-main">
      <header className="page-header">
        <h1 className="page-title">Humanity Centres</h1>
...
Object.assign(window, { Dashboard, Wallet, Centres, SendFlow, Notifications });
