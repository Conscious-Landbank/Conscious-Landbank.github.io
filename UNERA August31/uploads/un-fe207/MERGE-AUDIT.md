...
Scope: **consumer web app only.** The Stablecoin institutional app, UneraAdmin and USAdmin consoles are separate products and were deliberately left out (they live in `CLB/Stablecoin *` and `NewUnera/UneraAdmin|USAdmin`).
