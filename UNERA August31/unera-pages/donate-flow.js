...
function goToStep(n, opts) {
  ...
  hideHcPreview();
  currentStep = n;
  ['step1', 'step2', 'step3', 'stepPay', 'stepProcessing', 'step4'].forEach(function (id) { $(id).classList.remove('active'); });
...
$('backTo2').addEventListener('click', function () { clearInterval(rateTimer); serverErrShown = false; goToStep(2); });
...
$('backTo3').addEventListener('click', function () { renderReview(); goToStep(3); });
